...
```jsonl
{"id":1,"payoutMultiplier":780,"events":[{"index":0,"type":"test","data":{"test":123}}]}
{"id":2,"payoutMultiplier":1000,"events":[{"index":0,"type":"test","data":{"test":123}}]}
{"id":3,"payoutMultiplier":0,"events":[{"index":0,"type":"test","data":{"test":123}}]}
...
```
