...
<Steps>
<Step>
Install [Rust](https://rust-lang.org/tools/install/) and cargo if you haven't already.
...
Since the optimizer is created by Stake and not the Slot Engine team,
[consult their docs](https://stake-engine.com/docs/math/optimization-algorithm)
for any more information you may need, or ask on the Stake Engine Discord server.
</Callout>
