...
<Steps>
  ...
  <Step>
    ...
    You can [read more here](/docs/core/configuration).
...
<Callout title="Good to know">
  Before configuring your game, you should get familiar with the [concepts and ideas](/docs/core/core-concepts) of the Core library
  to learn important terminology and background info. If you've used the Stake Math SDK before,
  many concepts will feel familiar.
</Callout>
